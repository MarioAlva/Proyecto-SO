    ...
    public partial class Form1 : Form
    {
        ...
        private void IniciarSesion_Click(object sender, EventArgs e)
        {
            //codigo 1 inciar sesion
                ...
                if (registrado == 1)
                {
                    MessageBox.Show("Usuario Iniciado");
                }
                else
                {
        ...
        {
            if (radioButton1.Checked) //Jugador con mas victorias
            {
                ...
                MessageBox.Show(textBox1.Text + "Tiene " + mensaje + "€");
            }
            else if (JugadorContrincante.Checked) //Jugador Contrincante
            {
                ...
                server.Receive(msg2);
                mensaje = Encoding.ASCII.GetString(msg2).Split('\0')[0];
                MessageBox.Show(textBox1.Text + " ha jugado contra " + mensaje);
        ...
        private void JugadorContrincante_CheckedChanged(object sender, EventArgs e)
        {
